...
public class Main extends Calculator {
    ...
    public static void main(String[] args) {
        ...
        Main obj = new Main(); //object declaration to call parent class
        char choice = 'Y';
        System.out.println(" The java programme to perform the operation between the number");
        do {
